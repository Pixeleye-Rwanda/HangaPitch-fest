  ...
  <div class="overflow-hidden">
    <div class="min-h-screen">
      ...
      <div class="relative h-screen min-h-[400px] max-h-[670px] sm:max-h-[800px] lg:max-h-[900px] xl:max-h-[1000px]">
        ...
        <div
          class="font-rockinsoda absolute  text-white text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl top-2/4 left-4 sm:left-8 md:left-12 lg:left-16 xl:left-20 xl:2/4 text-center sm:text-left"
          ref="text">
          <p>READY TO PITCH YOUR</p>
          <p>TECH-ENABLED IDEA?</p>
        </div>

        <div class="absolute top-2/3 left-4 sm:left-12 lg:left-20  xl:left-26 mt-24">
          <button
            class="py-4 px-8 font-gramatika bg-white text-black font-semibold hover:bg-tangerine hover:text-white">
            <a href="https://hanga.acceleratorapp.co/application/new?program=hanga-pitchfest-" target="_blank">Apply
              Now</a>
          </button>
      ...
      <div class="flex flex-col lg:flex-row mt-12 lg:mt-20 px-6 w-full lg:space-x-10 ">
        ...
        <div class="text-justify mt-4 lg:mt-0 space-y-8 w-full lg:w-10/12">
          <p class="text-base lg:text-2xl font-gramatika text-navy">
            Do you believe you've got what it takes? You are only 4 steps closer to being part of the most exciting tech
            event in Rwanda. Make sure you have all the necessary documents and information ready to submit your
            application.
          </p>
          <div class="flex  lg:justify-start">
            <button class="py-4 px-8 font-gramatika bg-tangerine text-white hover:bg-tangerine-dark transition-all"
              ref="button">
              <a href="https://hanga.acceleratorapp.co/application/new?program=hanga-pitchfest-" target="_blank"
                class="mt-6">Apply
                Now</a>
        ...
        <div class="relative absolute  w-full pt-32 lg:pt-60 ">
          <div class="flex flex-col absolute lg:flex-row lg:justify-between space-y-24 lg:space-y-0 lg:space-x-8">
            ...
            <div class="w-full absolute  lg:w-1/4 space-y-4 relative">
              ...
              <p class="font-gramatika text-lg text-darkGray">Sign up on Hanga by clicking on the <a
                  href="https://hanga.acceleratorapp.co/application/new?program=hanga-pitchfest-"
                  class="text-tangerine font-bold">official link to registration</a></p>
            </div>
            ...
            <div class="w-full lg:w-2/5 space-y-24 lg:space-y-44">
              <div class="w-full space-y-4 -mt-4 relative">
                ...
                <div class="space-y-8 pt-8">
                  ...
                  <p class="font-gramatika text-lg text-darkGray">Log in to your Hanga Pitchfest account. Complete the
                    application form with accurate details about your startup and upload any required attachments</p>
                </div>

              </div>
              <div class="w-full  space-y-4 relative">
                <img src="../assets/four.svg"
                  class="absolute -top-16 left-0 lg:-top-16 2xl:top-32 lg:left-12 h-16 w-16">
                <div class="space-y-4  pt-8 lg:pt-8  2xl:pt-52">
                  <p class="font-rockinsoda text-4xl text-navy">Submit Project</p>
                  <p class="font-gramatika text-lg text-darkGray">Review your application form to ensure all information
                    is accurate and complete. Once you're satisfied with the application, click the "Submit" button.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class=" relative mt-96 lg:mt-60 2xl:mt-24">
        ...
        <div class=" ">
          ...
          <select v-model="selectedYear"
            class=" float-right mr-20 w-30 bg-white ring-1 ring-lightTangerine outline-none p-2 px-4">
        ...
        <div class="flex  mt-16 mb-10">
          <div v-for="winner in filteredWinners" :key="winner.name" class="relative h-[582px] w-[400px] flex-shrink-0  "
            :class="winner.class">
        ...
        <!-- next section -->
        <div class="mt-24 sm:mt-32 bg-cover h-full"
            ...
            <div class="slide-up space-y-8" ref="texty">
              ...
              <div className="space-y-10">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 items-center">
                  <img src="../assets/2023/loopa.svg" alt="Loopa"
                    className=" w-[15vh] h-[15vh] lg:w-[20vh] lg:h-[20vh]" />
                  <img src="../assets/2023/hova.svg" alt="Hova"
                    className=" w-[15vh] h-[15vh] lg:w-[20vh] lg:h-[20vh]" />
                  <img src="../assets/2022/umurava.svg" alt="Umurava"
                    className="w-[20vh] h-[20vh] lg:w-[25vh] lg:h-[25vh]" />
                  <img src="../assets/2023/medixr.svg" alt="MedixR"
                    className=" w-[20vh] h-[20vh] lg:w-[20vh] lg:h-[20vh]" />
              ...
              <div className="space-y-10">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 items-center">
                  <img src="../assets/2022/lifesten.svg" alt="Lifesten"
                    className="w-[15vh] h-[15vh] lg:w-[20vh] lg:h-[20v]" />
                  <img src="../assets/2022/paying-tone.svg" alt="Paying Tone"
                    className="w-[15vh] h-[15vh]  lg:w-[20vh] lg:h-[20v]" />
                  <img src="../assets/2022/school-nest.svg" alt="School Nest"
                    className="w-[15vh] h-[15vh] lg:w-[30vh] lg:h-[30v]" />
                  <img src="../assets/2022/huza.svg" alt="Huza" className="w-[15vh] h-[15vh] lg:w-[20vh] lg:h-[20v]" />
                  <img src="../assets/2022/mukika.svg" alt="Mukika"
                    className="w-[15vh] h-[15vh] lg:w-[20vh] lg:h-[20v]" />
                </div>
                <hr className="border-lineColor border-t-2" />
              </div>
              ...
              <div className="space-y-10">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-12 items-center">
                  <img src="../assets/2021/afroduino.svg" alt="Afroduino"
                    cclassName=" w-[35vh] h-[35vh] lg:w-[45vh] lg:h-[45v]" />
                  <img src="../assets/2021/second-life-storage.svg" alt="Second Life Storage"
                    className=" w-[25vh] h-[25vh] lg:w-[30vh] lg:h-[30v]" />
                  <img src="../assets/2021/bag.svg" alt="Bag" className="w-[12vh] h-[12vh] lg:w-[20vh] lg:h-[20v]" />
                  <img src="../assets/2021/karisimbi.svg" alt="Karisimbi"
                    className="w-[25vh] h-[25vh] lg:w-[30vh] lg:h-[30v]" />
                  <img src="../assets/2021/hova 2.png" alt="Hova 2"
                    className="w-[15vh] h-[15vh] lg:w-[20vh] lg:h-[20vh]" />
                </div>
              </div>
            </div>
        ...
        <!-- Responsive Section -->
        <div
          class="flex flex-col lg:flex-row mt-16 lg:mt-44  space-y-8 lg:space-y-0 lg:space-x-16 px-6 lg:px-12 w-full mb-16">
          <!-- Text Section -->
          <div class="w-full lg:w-1/2 mt-16 lg:mt-32 2xl:mt-80">
            <div class="space-y-2">
              <p class="text-3xl lg:text-7xl font-rockinsoda text-navy">CONNECT WITH LIKE-MINDED</p>
              <p class="text-3xl lg:text-7xl font-rockinsoda text-navy">ENTREPRENEURS AT HANGA HUBs</p>
            </div>

            <div class="mt-8 text-justify space-y-12">
              <p class="text-navy font-gramatika text-lg lg:text-xl 2xl:text-2xl ">
                HANGA Hubs is an action funded by the European Commission and it is implemented by RISA. It operates in
                MUHANGA, NYAGATARE, RUBAVU, and RUSIZI. The action is part of the Rwanda Government’s and the European
                Union’s efforts to support private sector development and job creation in Rwanda through Innovation and
                Incubation hubs.
              </p>
              <button
                class="mt-6 py-4 px-6 lg:px-8 font-gramatika bg-tangerine text-white font-semibold hover:bg-tangerine-dark transition-all"
                ref="button">
