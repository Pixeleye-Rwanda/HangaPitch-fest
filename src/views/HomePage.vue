      ...
      <div class="relative h-screen min-h-[400px] max-h-[670px] sm:max-h-[800px] lg:max-h-[900px] xl:max-h-[1000px]">
        ...
        <div class="absolute top-2/3 left-4 sm:left-12 lg:left-20 xl:left-26">
          <div class="flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0">
            ...
            <button
              class="hero-button p-3 px-6 font-gramatika border text-white font-semibold hover:bg-tangerine hover:text-black flex items-center space-x-2 transition-all duration-300">
        ...
        <div class="mt-20 py-16 sm:mt-32 bg-cover h-full"
          ...
          <div class="flex flex-col-reverse lg:flex-row items-center lg:items-start lg:justify-between">
            ...
            <div
              ...
              <button
                class="bg-tangerine text-white text-md sm:text-xl py-3 sm:py-4 px-8 sm:px-12 hover:bg-orange-500 hover:scale-105 transition-all duration-300 ease-in-out">
            ...
            <div
              ...
              <img src="../assets/Vector 6.png"
                class="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-none h-auto object-contain">
            </div>
                ...
                <div class="absolute inset-0"
                  ...
                  <div class="absolute bottom-0 inset-x-0 p-4 text-center fade-in">
                    <p class="text-white text-lg text-justify font-gramatika p-2">
                      ...
                      Hanga Pitchfest a two-fold approach. We are nurturing the rich talents and innovation of our young
                      people, while recognizing the contributions of talented innovators to socio-economic development.
                    </p>
              ...
              <div class="relative aspect-w-16 h-[60vh] aspect-h-10 ">
                ...
                <div class="absolute inset-0"
                  ...
                  <div class="absolute bottom-0 inset-x-0 p-4 text-center fade-in">
                    <p class="text-white text-lg text-justify font-gramatika p-2">
                      <span class="font-rockinsoda text-tangerine text-5xl ml-2">"</span>
                      There have been, in my opinion, too much talking. We need to act now, but I believe it is very
              ...
              <div class="absolute inset-0"
                ...
                <div class="absolute bottom-0 inset-x-0 p-4 text-center fade-in">
                  <p class="text-white text-justify text-xl font-gramatika p-2">
                    <span class="font-rockinsoda text-tangerine text-5xl ml-2">"</span>
                    Today is a celebration of talent, ambitions and the boundless opportunities that arise when passion,
                    creativity, determination and the resolve to be self-reliant converge to push the boundaries of
                    innovation.
                  </p>
                  <div class="flex space-x-2 ml-2">
                    <hr class="w-[50px] border-2 mt-2">
                  ...
                  <div class="absolute bottom-8 left-8">
                    ...
                    <div class="mt-2">
                      <p class="text-white font-gramatika text-lg">Addressing the obstacles & gaps limiting early-stage
                        startups.</p>
                      <router-link to="/hub">
                        <a href="" class="text-white font-gramatika underline" target="_blank">Learn more</a>
                      </router-link>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="p-4 sm:p-6 md:p-8 h-full flex flex-col justify-between">
                      ...
                      <div>
                        <transition name="slide-up" appear>
                          <h2 class="text-white font-rockinsoda text-3xl sm:text-3xl md:text-4xl ">BK ARENA TO BE USED
                            FOR<br>HANGA 2024</h2>
                        </transition>
                        <p class="text-white font-gramatika text-md sm:text-base mt-2">The largest in-person technology
                          event in Rwanda designed to ignite & inspire innovation.</p>
      ...
      <div class="lg:-mb-10" ref="observerElement5">
        <transition name="slide-up" appear v-if="isVisible5">
          <div class="mt-24 ml-8 space-x-2">
            <h1 class="font-rockinsoda text-3xl sm:text-4xl lg:text-7xl text-navy">2023</h1>
            <h1 class="font-rockinsoda text-3xl sm:text-4xl lg:text-7xl text-navy">NOTABLE SPEAKERS</h1>
          </div>
        </transition>
        <div class="relative overflow-x-auto whitespace-nowrap scrollbar-hide mt-16 ml-0 lg:ml-12" ref="scrollContainer"
          style="height: 800px;" @touchstart="handleTouchStart" @touchmove="handleTouchMove">
