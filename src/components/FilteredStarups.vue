...
export default{
    ...
    data(){
                ...
                return{
                    ...
                    { name: 'Farmoja', category: 'Agriculture', year: 2023 },
                    ...
                    { name: 'Quarks', category: 'Fintech', year: 2023 },
                    { name: 'Smart Class', category: 'Education', year: 2023, logo: require('../assets/2023/smart-class.svg') },
                    { name: 'Smart Ikigega', category: 'Agriculture', year: 2023 },
                    ...
                    { name: 'Vitaway E-clinic', category: 'Health', year: 2023 },
