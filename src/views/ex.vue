<template>
  <div class="overflow-hidden">
   ...
   <!-- Responsive Section -->
<div class="flex flex-col lg:flex-row mt-16 lg:mt-32 space-y-8 lg:space-y-0 lg:space-x-16 px-6 lg:px-12 w-full mb-16">
  <!-- Text Section -->
  <div class="w-full lg:w-1/2 mt-16 lg:mt-32">
    <div class="space-y-2">
      <p class="text-3xl lg:text-5xl font-rockinsoda text-navy">CONNECT WITH LIKE-MINDED</p>
      <p class="text-3xl lg:text-5xl font-rockinsoda text-navy">ENTREPRENEURS AT HANGA HUBs</p>
    </div>

    <div class="mt-8 text-justify space-y-6">
      <p class="text-navy font-gramatika text-sm lg:text-md">
  ...
  <!-- Image Section -->
  <div class="relative h-[400px] lg:h-[520px] w-full lg:w-1/2 flex-shrink-0 mt-8 lg:mt-32">
